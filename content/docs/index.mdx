...
<Cards>
  <Card title="Installation Guide" href="/docs/installation/docker">
    Set up Pyrodactyl using Docker
  </Card>
  <Card
  ...
  <Card
    title="Configuration"
    href="/docs/installation/docker#panel-configuration"
  >
    Learn how to configure your Pyrodactyl instance
  </Card>
  <Card
    title="Wings Setup"
    href="/docs/installation/docker#node-configuration"
  >
...
For existing Pterodactyl Docker users, you can switch to Pyrodactyl by updating the image in your Docker Compose file:
